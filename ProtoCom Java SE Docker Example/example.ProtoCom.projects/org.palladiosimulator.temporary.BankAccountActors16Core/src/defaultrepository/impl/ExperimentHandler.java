...
//        System.out.println("iExperimentManager_simulateTransactions0 is called");
        ...
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction3_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction4_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction5_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction6_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction7_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction8_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction9_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction10_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction11_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction12_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction13_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction14_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction15_ExperimentHandler());
        iTransactionExperimentHandlerList.add(this.myContext.getRoleRequired_ITransaction16_ExperimentHandler());
